...
module.exports = {
  templateValidate (input) {
    const schema = Joi.object().keys({
      ...
      user_id: Joi.number().integer().required().default(1),
      user_name: Joi.string().required().default("shahroze"),
      ...
      mappingKeyWords: Joi.array().allow(null),
